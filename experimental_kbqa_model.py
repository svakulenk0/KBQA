...
class KBQA:
    ...
    def load_KG_embeddings(self, KG_relation_embeddings_file=KB_RELATION_EMBEDDINGS_PATH, KG_word_embeddings_file=KB_WORD_EMBEDDINGS_PATH):
        '''
        ...
        with open(KG_relation_embeddings_file) as rels_embs_file, open(KG_word_embeddings_file, load_word_embeddings) as word_embs_file:
    ...
    def train(self, batch_size, epochs, lr):
        with tf.Session() as session:
            ...
            session.run([self.model_train.output], feed_dict={kg_word_embeddings: [self.kg_word_embeddings_matrix.T]})
