...
from keras.layers import Input, GRU, Dropout, Embedding, Dot, Dense
...
class KBQA2:
    ...
    def build_model(self):
        ...
        # A - answer decoder
        answer_output = Dot(axes=1, normalize=True, name='answer_output')([question_encoder_output, kg_embeddings_input])
