...
class KBQA:
    ...
    def __init__(self, rnn_units, model_path='./models/model.best.hdf5'):
        ...
        self.kg_concatenated_embeddings_matrix = np.concatenate((self.kg_word_embeddings_matrix, self.kg_relation_embeddings_matrix), axis=1)
    ...
    def build_model(self):
        ...
        # Q' - question encoder
        question_encoder_output_1 = GRU(self.rnn_units, name='question_encoder_1', return_sequences=True)(question_embeddings_input)
        ...
        # A - answer output
        answer_output = Lambda(self.answer_product, name='answer_output')([question_encoder_output, kg_embeddings])
